...
from vgts.structures.transforms import TransformList, crop
import vgts.structures.transforms as transforms_boxes
from .dataset import build_dataset_by_name
from vgts.utils import get_image_size_after_resize_preserving_aspect_ratio


def build_eval_dataloaders_from_cfg(cfg, box_coder, img_normalization, datasets_for_eval=[], data_path="", logger_prefix="VGTS.eval"):
    if data_path:
...
def build_train_dataloader_from_config(cfg, box_coder, img_normalization, dataset_train=None, data_path="", logger_prefix="VGTS.train"):
