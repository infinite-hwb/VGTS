...
from ots.modeling.model import build_OTS_from_config

from ots.loaddata.dataloader import build_eval_dataloaders_from_cfg, build_train_dataloader_from_config
from ots.engine.train import trainval_loop
from ots.utils import set_random_seed, get_trainable_parameters, mkdir, save_config, setup_logger, get_data_path
from ots.engine.optimization import create_optimizer
from ots.config import cfg
...
def init_logger(cfg, config_file):
    ...
    logger = setup_logger("OTS", output_dir if cfg.output.save_log_to_file else None)
...
def main():
    ...
    net, box_coder, criterion, img_normalization, optimizer_state = build_OTS_from_config(cfg)
