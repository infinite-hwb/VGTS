...
from ots.structures.bounding_box import BoxList
from ots.engine.augmentation import DataAugmentation
from ots.utils import get_image_size_after_resize_preserving_aspect_ratio, mkdir, read_image
...
def build_dbtest_dataset(data_path, name, eval_scale, cache_images=False, no_image_reading=False, logger_prefix="OTS"):
...
def build_db_dataset(data_path, name, eval_scale, cache_images=False, no_image_reading=False, logger_prefix="OTS"):
    logger = logging.getLogger(f"{logger_prefix}.dataset")
...
def build_dataset_by_name(data_path, name, eval_scale, cache_images=False, no_image_reading=False, logger_prefix="OTS"):
...
class DatasetOneShotDetection(data.Dataset):
    def __init__(self, gtboxframe, gt_path, image_path, name, image_size, eval_scale,
                       ...
                       image_ids=None, image_file_names=None, logger_prefix="OTS"):
